...
//		MemberDTO member = new MemberDTO("테스트용 이메일" + i, "테스트용 비밀번호" + i, "테스트용 이름" + i, Date.valueOf("2022-08-22"),
...
//		final String memberEmail = "테스트용 이메일1";
//		final String memberPassword = "테스트용 이메일1";
//		String memberName = "1";
